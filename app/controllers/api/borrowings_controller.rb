...
class Api::BorrowingsController < Api::BaseController
  ...
  def create
    ...
    forbidden! I18n.t('api.forbidden.print_book_not_for_borrow') unless print_book.borrowable?
    forbidden! I18n.t('api.forbidden.request_self_book') if print_book.holder_id == current_user.id
    forbidden! I18n.t('api.forbidden.request_duplicates') unless Borrowing.current_applied_by(current_user.id)
  ...
  def accept
    ...
    forbidden! I18n.t('api.forbidden.not_the_holder') unless @borrowing.holder_id == current_user.id
    @borrowing.accept
  ...
  def borrow
    forbidden! I18n.t('api.forbidden.not_the_applicant') unless @borrowing.receiver_id == current_user.id
