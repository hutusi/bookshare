...
class Api::SharingsController < Api::BaseController
  ...
  def accept
    ...
    forbidden! I18n.t('api.forbidden.not_the_holder') unless @sharing.holder_id == current_user.id
    @sharing.accept
  ...
  def borrow
    forbidden! I18n.t('api.forbidden.not_the_applicant') unless @sharing.receiver_id == current_user.id
